        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            {contactInfo.map((info, index) => (
              <div
                key={index}
                className={`group p-8 rounded-3xl bg-glass border-2 border-${info.color}/20 hover:border-${info.color}/40 transition-all duration-500 cursor-pointer hover:shadow-card-elevated`}
              >
                <div className="flex items-start gap-6">
                  <div
                    className={`w-16 h-16 bg-${info.color}/10 rounded-2xl flex items-center justify-center group-hover:bg-${info.color}/20 transition-all group-hover:scale-110`}
                  >
